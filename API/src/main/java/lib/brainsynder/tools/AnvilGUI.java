package lib.brainsynder.tools;

import lib.brainsynder.IVersion;
...
public class AnvilGUI {
     ...
     */
    private static final VersionWrapper WRAPPER = match();
    ...
    private static VersionWrapper match() {
        IVersion version = ServerVersion.getVersion();
        try {
            return (VersionWrapper) Class.forName("lib.brainsynder.nms.version.Wrapper_" + version.name()).newInstance();
